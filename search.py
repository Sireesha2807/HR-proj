...
def DisplayForm():
    ...
    lbl_text = Label(TopViewForm, text="Job Profiles", font=('verdana', 18), width=600,bg="#1C2833",fg="white")
    ...
    tree = ttk.Treeview(MidViewForm,columns=("Name", "Age", "Gender", "Phone Number","Technologies Knows","Educational Qualification","Location"),
    ...
    tree.heading('Technologies Knows', text="Technologies Knows", anchor=W)
    tree.heading('Educational Qualification', text="Educational Qualification", anchor=W)
...
def SearchRecord():
    ...
    if SEARCH.get() != "":
        ...
        cusr.execute("SELECT * FROM person WHERE name=? ",(search.get(),))
